...
import com.example.rokidglassesappcenter.host.AppMgrClient
import com.example.rokidglassesappcenter.host.ClientBootstrap
import com.example.rokidglassesappcenter.host.Constants
import com.example.rokidglassesappcenter.host.RokidGlassesAppCenterHostApplication
...
class AppListViewModel : ViewModel() {
    ...
    fun init(context: Context, token: String?) {
        ...
        (context.applicationContext as? RokidGlassesAppCenterHostApplication)?.sharedCxrLink = link
        link.connect(token)
    }
        ...
        viewModelScope.launch {
            ...
            when (result) {
                ClientBootstrap.Result.Started -> {
                    ...
                    client = c
                    (appContext as? RokidGlassesAppCenterHostApplication)?.sharedAppMgrClient = c
                    refresh()
                }
    ...
    fun release() {
        ...
        bootstrap = null
        bootstrapped = false
        (appContext as? RokidGlassesAppCenterHostApplication)?.let {
